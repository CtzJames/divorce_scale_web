...
export const NARCISSISM_RISK_SERVICE_INTENT_OPTIONS = [
  { value: "professional_support", label: "需要专业支持" },
  { value: "deep_report", label: "仅需深度报告" },
];

const DEFAULT_SERVICE_INTENT = NARCISSISM_RISK_SERVICE_INTENT_OPTIONS[0];
...
export function resolveNarcissismRiskServiceIntent(value) {
  ...
  return matchedIntent ?? DEFAULT_SERVICE_INTENT;
}
